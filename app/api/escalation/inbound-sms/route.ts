 ...
 * true for a publicly reachable route would let anyone brute-force a
 * pending escalation's 4-digit response code (10,000 possibilities)
 * and approve/reject a real approval with no phone involved at all.
 * The mock provider is only ever meant to be exercised by calling the
 * service directly (see this phase's own tests), never over HTTP.
 */
